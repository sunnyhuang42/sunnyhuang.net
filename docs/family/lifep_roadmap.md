...
当然**每个阶段的名字不重要**，用 A B C D E 来命名这些阶段也都 OK，**关键是探寻人生伴侣路上要解除的风险有哪些、处理的优先级排序是怎样的**。
...
如果相互欣赏吸引，且愿意支持彼此的人生目标规划（包括对家庭的规划，如希望什么时候组建家庭、要孩子，要几个等），可考虑进入下一阶段继续相互了解。
...
> [宣宣原本的路线图](https://m.igetget.com/share/note/detail/AaWVPxLgY8D5pMayPkXL91DqwEoXJ9)
