...
需要注意的是，**每个阶段的名字不重要**，用 A B C D E 来命名这些阶段也都 OK，**关键是识别在 探寻人生伴侣 路上，要解除哪些风险，按什么优先级来处理能最大程度降低双方的试错成本**。
...
如果相互欣赏吸引，且愿意支持彼此的人生目标规划（包括对家庭的规划，如希望什么时候组建家庭、要孩子，要几个、性别有无偏好等），可考虑进入下一阶段继续相互了解。
