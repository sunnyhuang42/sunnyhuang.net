...
关于能否玩到一起，我已能从「[相识十五问](family/lifep_Ad?id=q_knowu)」里看出对方是否偏好创造型快乐、有多大可能同频共振。且当想去做什么事情时，对我来说可以很容易征集到志同道合的伙伴一起。七年前如此（比如[改变我玩耍习惯的 10 场活动](selfedu/IdxActivity.md)），现在依旧（比如张罗[输出实验室](f_output/)的过程）。至少目前来看，并不需要且也很难找一个人，在我想玩的各方面都能一起。所以无需专门设个阶段，来检验彼此能否玩到一起。
