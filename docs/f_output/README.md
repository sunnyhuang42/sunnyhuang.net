...
?> 友情提示：
这个页面会持续迭代更新。如果你对「促进自己持续输出」感兴趣，可以收藏本页面，以便随时取用最新内容。
...
- **输出**：
    ...
    - 其次，这里的**「输出」其实范围很广**，只要是**跟个人发展相关的、有挑战的目标**，都算。因为要达成这些目标，其实都会自然在且需要在卡片、文件甚至项目层级，有输出。
...
!> **敲黑板**: <br> 当前阶段尤其期待有这些特质的伙伴：<br> （1）**打算打造一款上进青年喜爱的产品**。比如创建自己的个人品牌 / 课程，或者打磨一款面向上进青年的产品 / 服务等 <br> （2）**未来 2-3 个月，想高频了解目标用户反馈、快速迭代完善想法，更快打造用户喜爱的产品** <br> <br> 因为最近小组玩法已逐步跑顺，且感兴趣的伙伴越来越多，是时候开始摸索解决下一个风险：如何扩展这套玩法、促进更多伙伴持续输出。<br> <br>  如果你身边有契合上述特质的伙伴，还**请把这个帖子分享给他**，给他多一个选择，同时也助我们找到更多同行伙伴。感激不尽 🤗 
...
以及，如果需要给较多背景信息、深度思考才易有高质量产出，会上处理这类需求其实不契合「输出实验室」的使命，也不匹配「小组定期碰头时段」的资源特性。

因为这类问题需要提议人和参会人在会前做较多准备，成本较高，可长期持续的难度较高。而一旦准备不足，那其实现场通常难以满足提议人的需求，其他伙伴也难免感到自己把时间花在这里价值感不足。


那实现个人目标路上遇到难题，怎么办？建议：
...
实际上，**欢迎你及时根据新的信息输入，调整目标，以便注意力聚焦在，通往人生大目标的最佳发力点**。
...
- 当时为什么想定那个目标？背后的考虑是？
- 现在回看，如果有机会回到当初，你会把目标定成什么？为什么？
- 如果和当初定的目标不一样，这反映了自己哪些地方值得调整？下次可以如何避免重蹈覆辙？
