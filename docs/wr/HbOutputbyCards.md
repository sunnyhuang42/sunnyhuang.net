...
如果看过我 [《卡片助力输入输出，工具我选 WorkFlowy 》](selfedu/HbOutputWorkFlowy.md) 这篇文章，你应该知道若想畅快输出作品，为何卡片层级重要，以及如何挑选卡片工具。甚至你已尝试我推荐的方法，借 WorkFlowy 优化工作生活。
...
1. 如果想练习写作，那就**尽量用对外口吻而非纯心理过程的日记口吻**。如此，未来更易用在正式作品中。
    ...
    未来稍加修改，就可用于文章。比如这段后来就用到了 [Swing 新人指南](http://localhost:3000/#/swing/HbBeginner?id=%e4%bb%80%e4%b9%88%e6%97%b6%e5%80%99%e8%b8%8f%e5%85%a5-swing-%e4%b8%9b%e6%9e%97%e6%9b%b4%e5%90%88%e9%80%82%ef%bc%9f) 中。总之你**想怎么用，平常就怎么练**，不会错。
...
- [GitHub](https://github.com/)：我最常用的文档托管平台。它可供性极强，且内置很多专家级的内隐模式，如果使用得当，能极大降低个人创作复杂度。如果你之前没接触过，别被不明觉厉的操作吓退，可看我梳理的这份 [给文字工作者的 GitHub 上手攻略](wr/HbGitHubPre.md)。实在难以学会也别勉强，可用下文云端同步的替代方案，甚至只保存在本地。
...
- [WorkFlowy](https://workflowy.com/) ：我用了快 5 年的卡片层级工具。真爱一生推，玩转指引见 [《卡片助力输入输出，工具我选 WorkFlowy 》](selfedu/HbOutputWorkFlowy.md)。
...
比如我，这卡那卡都体验了一把，还是钟情大二就开始的习惯：输出始于**横着 A4 纸**捕捉灵感、梳理思路，写画不羁。一些长文如[《谢谢你给她的时光》](selfedu/Letter2XY4y2017.md)、[《你丁酉年的故事》](selfedu/Review2017.md)以及本文，更是如此：不仅起念阶段，甚至每个组块都要好几张 A4 纸自由写画，梳理想传递什么、引发什么行动，才敲成字符。当然，还会混合其他姿势，比如本文提到的随时记忆外部化+一个人的微博、之前推荐的 WorkFlowy 等。
...
比如查论文得知「[一个人的快乐程度，和他经历的快乐次数正相关，而非经历的快乐强度](https://link.springer.com/chapter/10.1007/978-90-481-2354-4_10)」，更要继续保持「[专注一小时，swing 十分钟](selfedu/YouNeedSwing.md)」的小憩节奏。

再如上网听闻「[初级商业人士拼体能，中级拼技能，高级又回到拼体能](mur/TipsMorningExercise.md)」，发觉应加大有氧运动量，但自己经常偷懒，便有了「如果私教训练完很累想偷懒，就先喝点水，在健身房外的楼道里来回慢走 5 分钟后，再开始做有氧」的行动脚本。
...
- 十二月：发出[《谢谢你给她的时光》](selfedu/Letter2XY4y2017.md)。第一次全篇写故事，终于有底气说自己从「逻辑」「文采」，爬上了「故事」这座写作第三峰。
...
- 二月：发布个人年度回顾[《你丁酉年的故事》](selfedu/Review2017.md)。尝试换个视角记录生活：用预言的方式写回顾，呈现自评反思更自然；并发现自己已能谋篇布局万字故事。还在写作过程更清晰自己要去何方。
