...
最后更新于 2021-12-31，创建于 2021-12-30
...
之前看到《了不起的我：自我发展心理学》中的这段话，心有戚戚——这像极了从零策划产品的创业过程（见下图）：你最初以为的方案，和实际最后管用的，大概率不是同一个……唯有不断「提出假设-验证假设」，持续根据反馈迭代方案——
...
这两个词，其实很多伙伴都知道，也知道这对加速职业转型很关键。但前段时间访谈下来，大部分人又很难做到。
...
如果知道了正确方法，却依然没做到，则可能是意愿准备度不足（不想做）和/或能力准备度不足（不会做）——

如果行动**意愿不足**，根据动机心理学的「价值-期望」理论，此时通常是缺「期望」——对自己或行动的成效缺乏信心，或没感受到这么做的「价值」——感觉这么做的「投入产出比」不高。

如果**能力不足**，通常是训练不够有效——没有训练目标、目标不合理或没有反馈，或有效训练的量不够。

<br> 

这么看来，「以终为始」「敏捷迭代」这些关键技能本就复杂，掌握一项复杂技能的过程更不简单，而职业转型时间又很宝贵，怎么办？
...
?> 把「拥抱不确定」的最佳实践，融入你探索职业转型过程，在相似任务场景下陪你一同练习、加速内化
...
看到这款产品服务能给用户带来这样的影响，我作为产品策划人，真的很开心。不仅为他们开心，也为自己开心——这款产品就是用以终为始、敏捷迭代的方法，快速迭代演进的。用户的变化，令我更确信这套方法论的价值，也更清楚自己的掌握程度进步如何。
