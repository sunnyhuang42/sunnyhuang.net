---
title: 如何梳理有助于达成长期目标的行动规划？
date: 2021-08-20
updated: 2021-12-23
description: <p>如果希望自己促进自己输出价值，离不开结果导向、以终为始地思考行动规划，并持续根据最新信息输入，迭代完善。</p><p>这是一些我综合目标管理、教练技术、WOOP 等方法，实践下来帮助较大的行动攻略，供参考。</p><p>如果你有疑问建议，欢迎随时和我交流，也促进我迭代完善 🤗</p>
---
...
3. `差距`：相较终态，差距主要有哪些？
4. `行动`：
    - 接下来重点做什么/解决什么问题或挑战，对实现终态「投入产出比」最高？为什么这么说/依据是？
    - 可参考下述角度来思索：
        1. 如果其他都保持现状，改变哪一点/解决哪个问题，能对实现终态带来最大收益？
        2. 如果想实现终态，很重要但解决起来又最简单的问题是什么？
        3. 有没有比探索解决这个问题，「投入产出比」更高、更值得先去探索或验证的？
...
比如可以把「终态」定为「月目标」「周目标」或其他周期的目标，来倒推思考下一步做什么、交付什么成果，对实现终态「投入产出比」最高。

#### 2. 关于理想生活，想到什么就先写什么

哪怕只想到几句话，甚至几个关键词，先写下来，也有助于自己以终为始。未来持续迭代完善就好。

比如[我期待的生活画面](about/idealife)，最开始也只有几句话，现在越来越丰富。

如果你想了解幸福人生有哪些模式、特征，可参考我之前采集的一些材料：[理想人生是怎样的，有哪些模式？](cmty/model_idealife)


#### 3. 若梳理的是近期目标规划，尽量不把「理想生活」作为终态来找差距

如果你想梳理的是近 1-3 个月的目标规划，建议不要把「理想生活」作为终态来找差距。因为这样跨度跳跃太多，找出下一步关键行动的难度很大。且从这几个月输出实验室成员的实践来看，如果跨度跳跃太多，无论是拆解还是推进目标规划，都易遇到本可避免的困难。
...
#### 4. 具体如何拆解到近期目标规划？ {#howplan}

我的思考和探索过程，可参考 [答师友：我的发展规划是怎么梳理出来的？](cmty/tips_MBOlifeplan)
...
- 接下来 X 个月，我最想重点解决的问题或挑战是什么？
    ...
    > - “接下来”的周期是多长，可以自己定义，比如半年/3 个月等都 OK
...
- 具体到近 3 个月/ 1个月，我期待解决哪些疑问、到什么程度？质量期待是怎样的？如何评估是否达到期待？
    > - 这里就可以用[ OKR 这套框架（具体见《OKR是一套严密的思考框架？这是啥意思？》）](cmty/tips_MBOKRframe) 来表达，促进自己更细致地思考
- 达成上述期待，会有哪些好处？
    > - 请尽情想象会有哪些好处，以便增强达成目标的动力
...
![mbo_1.png](https://ishanshan.zoomquiet.top/share/mbo_1.png#width=150)
...
具体可参考[如何从容应对新挑战？·研究最佳实践通用问题清单](cmty/tips_RES_BP)。
...
### 2. 关于思考好目标、执行好目标，更多参考材料 {#resmore}
...
![qr_courseokr_hy.jpeg](https://ishanshan.zoomquiet.top/share/qr_courseokr_hy.jpeg#width=150)     
