...
3个多小时的聊天愉快也忐忑，毕竟这是盘很大的棋，且无先例；而阳老只问了一些基本的甚至看似毫不相关的问题，便开始聊工作规划及分工。这是我们第一次正面接触，是什么让他如此快速就判定我一个初出茅庐的小姑娘合适？面对这个演进迅速的事物，自己是否值得一搏，且自己能否抗住，也是心里挥之不去的问号。估计阳老也看出我的犹豫，便建议我找 [@OliverDing](https://oliverding.medium.com/) 聊聊—— @Oliver 参与了开智从 0 到 1 的全过程，了解其中全部故事和转折，可以听听他的看法。
