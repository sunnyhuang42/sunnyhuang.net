...
const Toc = () => {
  ...
  return (
    <Drawer
      ...
      visible={toc.visible}
      onClose={toc.close}
      className="right-0 h-[calc(90vh-3.5rem)] w-full xl:sticky xl:top-14 xl:z-0 xl:h-[calc(100vh-3.5rem)] xl:w-72 xl:flex-shrink-0 xl:transform-none xl:transition-none"
    >
