...
近几个月我基本每天都会使用 [ChatGPT](https://chat.openai.com) 至少二十次，感觉提效了好几个台阶。于是在「[闪闪人生](https://sunnylife42.com)」的人生重点项目推进会上，常推荐大伙儿把这十亿美金的个人助理用起来。
...
典型比如内容应用场景（申请函/产品内测招募/产品推广/道歉信/……）、内容要点、字数要求、风格（严谨/富有创意/某位知名作者的风格/小红书风格）、格式（表格/列表）等。

如果在提要求时附上一些成果示例，会更可能得到靠谱结果。

具体例子可参考： [GPT best practices - OpenAI API](https://platform.openai.com/docs/guides/gpt-best-practices)
