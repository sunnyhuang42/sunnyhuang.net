...
有测量才易有进步。那信任/声誉（credit）的积累如何评估？
...
由此，当我们被寻求支持/合作的去解决的问题复杂度越高，意味着我们能提供的价值越大；被寻求支持/合作的去解决高复杂度问题的频率越高，也意味着我们能提供的价值越大。

此外，当我们要去解决的问题越复杂，所需的资源支持通常也越大。如此，所能撬动资源的大小和难易程度，也是 credit 积累情况的一大表征。

<br> 

前面两点不够吗，为什么还有「对外输出/交付成果的质量和数量」这最后一点呢？
...
比如前面提到的「被寻求支持/合作的问题复杂度和频率」「需要支持时，所能撬动资源的大小和难易程度」，这些成效不仅需长时间积累，还受一些我们不可控的因素影响，就属于典型的滞后性指标（lagging indicator）。

为了更大概率实现它们，需要找个引领性指标，也就是既能预见滞后性指标趋势，又是促进滞后性指标出现的关键方式，还属我们可控的。

想来想去，我目前觉得比较合适的引领性指标，就是「对外输出/交付成果的质量和数量」。

<br> 

需要澄清的是，引领性和滞后性是相对的概念 —— 比「对外输出/交付成果的质量和数量」更引领性的指标也有，比如「高质量练习的频次」等。
