...
* 采集用户阅读兴趣，以便书籍以更符合用户兴趣的顺序呈现，降低新用户流失概率：
	...
	* 建议改为 新用户进入后先选感兴趣的主题，根据兴趣个性化推荐，并提供检索；老用户需先选择阅读兴趣后才能继续阅读。
		...
		[![woniureadingdemocompare.jpg](https://cdn.sunnyhuang.net/share/woniureadingdemocompare.jpg?imageMogr2/size-limit/100k!)](https://cdn.sunnyhuang.net/share/woniureadingdemocompare.jpg)
