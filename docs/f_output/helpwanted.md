...
2. 过去半年已在我身上验证有效的[行动框架](https://docs.qq.com/flowchart/DVW5VZU1YWlFMWGdp)如下，接下来将继续完善和验证，尤其黄色标签标注的部分：
   ...
   ![fo_pattern_all.jpeg](https://ishanshan.zoomquiet.top/share/fo_pattern_all.jpeg )


### 此半年待探索回答的问题和优先级 :id=qlist

根据上述 OKR 和更远期的规划（见[个人发展规划@Sunny](/about/plan_lifedev)
），此半年待探索回答的问题和优先级如下：
...
如果 [这里（想探索的问题清单@Sunny](https://sunnylife.feishu.cn/wiki/wikcnEy7dsfx0hrcc7RJ123xceg?sheet=7e122f) ）所列问题，恰好也是你感兴趣、接下来很想重点探索的，那再好不过。很期待你起草出自己的问题清单，并小步高频地分享探索成果。
...
3. “新手常见误区”，通常是“反常识”中投入产出比更高的一类信息增量，毕竟这个世界新手总是占绝大部分。而且负面效应（negativity bias）普遍存在——「正面与负面的非对称性（positive-negative asymmetry）」告诉我们，同样的资源投入，用来避免错误做法，相较在正确做法上继续精进，投入产出比通常更高。
    ...
    ![positive-negative_asymmetry.jpeg](https://ishanshan.zoomquiet.top/clipping/positive-negative_asymmetry.jpeg)
...
### 3. 你在参与过程主动提升有助于小组长期持续运作的技能 :id=grow
...
4. 主动根据上述半年目标规划，以及[个人发展规划@Sunny](/about/plan_lifedev)，思索还有哪些共赢机会，并把握好他们
