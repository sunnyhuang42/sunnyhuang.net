# 如何更易获得有效帮助？· 困扰分析模板
最后更新于 2021-09-02，起草于 2021-08-19
...
2. 为什么想实现这个状态？这个状态对迈向你的人生目标/理想生活来说，很关键吗，为什么？如果不实现，给你带来的困扰是？
   ...
   3. 感觉自己一直没能花足够时间做那些对长期目标有益的事情，花在重要的事情时间不足，很不舒坦
3. 如果很关键，关于想实现的这个状态，你在时间/质量/成本/范围上的最低要求是？目前已搜索和尝试了哪些方法？效果如何？
   1. 最低要求
...
小王在参加输出实验室，希望更顺畅地用好输出实验室资源，解决自己的问题。
...
2. 为什么想实现这个状态？这个状态对迈向你的人生目标/理想生活来说，很关键吗，为什么？如果不实现，给你带来的困扰是？
    ...
    - 如果一直停留在学习如何使用阶段，会觉得没有参与感，也会让自己受挫。
...
2. 重要 =》
    1. 这事是令自己很有内在动机或使命感的吗？
        ...
        2. 不是 =》
            ...
            3. 没有 =》先梳理自己向往的理想生活是怎样的，然后回到上一步继续分析诊断
