...
2. **如何建立婚后健康良好的交往模式、各类家庭事务的决策机制**，比如
    1. 家庭财务的决策机制，如是否有各自的所辖领域、什么情况下需要共同商议、以什么规则来决策[^1]
...
当想去做什么事情时，对我来说可以很容易征集到志同道合的伙伴一起。七年前如此（见[改变我玩耍习惯的 10 场活动](selfedu/IdxActivity.md)），现在依旧（比如[输出实验室](f_output/)）。至少目前来看，并不需要且也很难找一个人，在我想玩的各方面都能一起。

至于床友…在我的认知里，只要双方相互欣赏信任、乐意沟通和练习，性生活合拍不会是问题 ;-) 而能否“相互欣赏信任、乐意沟通学习”这些特质，对我来说在战友阶段就已评估。所以也没必要在确认关系前，再设个阶段去检验性生活能否合拍：）
